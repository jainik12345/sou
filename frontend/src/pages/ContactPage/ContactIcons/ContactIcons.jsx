...
export const ContactIcons = () => {
  ...
  if (!contact) {
    return <div>No contact info found.</div>;
  }

  const phoneForWhatsapp = contact.phone_number
    ? contact.phone_number.replace(/[^0-9]/g, "")
    : "";
      ...
      <div className="max-w-screen-xl mx-auto py-10 px-2 grid md:grid-cols-3 grid-cols-1 gap-5 ">
        ...
        <div className="flex flex-row gap-5 p-5 relative items-start group w-full rounded-2xl shadow-md/50 transition-all duration-300 ease-in">
          ...
          <div className="flex flex-col gap-5 justify-center ">
            ...
            <p className="text-gray-500 font-semibold text-[1rem] group-hover:text-white">
              {contact.address ||
                "B-7001/702, Pntc, Radio Mirchi Road, Satellite, Ahmedabad"}
            </p>
          </div>
        </div>
        ...
        <div className="flex flex-row gap-5 p-5 relative items-start group w-full rounded-2xl shadow-md/50 transition-all duration-300 ease-in">
          ...
          <div className="flex flex-col gap-5 justify-center ">
            ...
            <a
              ...
              className="text-gray-500 font-semibold text-[1rem] group-hover:text-white underline"
              style={{ cursor: "pointer" }}
            >
              {contact.email || "booking@aalpine.in"}
            </a>
          </div>
        </div>
