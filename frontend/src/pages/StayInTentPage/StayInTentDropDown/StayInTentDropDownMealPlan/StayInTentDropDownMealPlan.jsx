...
//     !Array.isArray(FormattedData.mealPlans) ||
//     FormattedData.mealPlans.length === 0
//   ) {
//     return null;
//   }
...
//             Depending on how long your vacation is, you can choose 1 Night &amp;
//             2 Days Package with us. and below 6yr. Child Complimentary
//           </p>
//           <p className="text-center text-gray-500 mb-8">
//             For all of our visitors, our Soil to Soul Resort Package also comes
//             with interesting cultural programs that highlight the local culture.
//             After a full day of sightseeing, visitors can unwind and recuperate
//             on our lush green lawn.
//           </p>
//         </div>
...
//                 <h2
//                   className={`text-2xl font-semibold ${plan.color} mb-1 text-center`}
//                 >
//                   {plan.title}
//                 </h2>
