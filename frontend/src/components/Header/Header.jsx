  ...
  useEffect(() => {
    ...
    const FetchNavbarDropdownData = async () => {
      ...
      try {
        ...
        const FetchNavbarDropdownResponse = await axios.get(`${BE_URL}/souPackageName`);
        const FilteredFetchNavbarDropdownResponse = FetchNavbarDropdownResponse.data.data;
...
//     const fetchNavbarDropdownData = async () => {
//       try {
//         const response = await axios.get(`${BE_URL}/souPackageName`);
//         const data = response.data.data;
//         if (response.status === 200) {
//           const packageNames = data && data.map((pkg) => pkg.sou_package_name);
//           setSouDropdown(packageNames);
//         } else {
...
//   // Dynamic nav links, using souDropdown for Stay In Tent & Gallery
//   const navLinks = [
//     {
//       label: "Home",
//       path: "/",
