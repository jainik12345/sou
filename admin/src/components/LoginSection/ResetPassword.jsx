  ...
  return (
    <div className="relative min-h-screen w-full flex items-center justify-center bg-gradient-to-br from-orange-100 via-white to-orange-200 overflow-hidden">
      ...
      {openSnackbar && (
        ...
        >
          <div
            className={`flex items-center px-6 py-3 rounded-lg shadow-lg text-white font-medium
            ${
              success
      ...
      >
        ...
        <h1 className="text-3xl font-semibold text-orange-500 mb-2 text-center tracking-tight">
          Create New Password
        </h1>
        ...
        >
          ...
          <motion.button
            type="submit"
            className="mt-2  cursor-pointer w-[100%] py-3 rounded-2xl font-bold text-white text-lg tracking-wide bg-gradient-to-r from-orange-400 to-orange-500 shadow-lg hover:from-orange-500 hover:to-orange-600 transition-all duration-150"
          >
            Reset Password
          </motion.button>
        </form>
