...
const SOUPackageBGImageInsert = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await axios.post(`${BE_URL}/souPackageBgImage`, data, {
        headers: {
    ...
    <div className="p-6">
      <div className="border-2 border-blue-300 rounded-2xl p-6 shadow-md">
        <h2 className="bg-blue-600 text-white text-lg font-semibold py-3 px-5 rounded-md mb-8">
          Add SOU Package Background Image
        </h2>
...
export default SOUPackageBGImageInsert;
