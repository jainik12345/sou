...
const SOUPackageHeroSectionInsert = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await axios.post(`${BE_URL}/souPackageHeroSection`, data, {
        headers: {
...
export default SOUPackageHeroSectionInsert;
