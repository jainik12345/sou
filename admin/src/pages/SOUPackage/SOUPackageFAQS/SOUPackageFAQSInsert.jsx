...
const SOUPackageFAQSInsert = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // Submit each FAQ as separate record (if that's your backend design)
      for (let faq of formData.faqs) {
        await axios.post(`${BE_URL}/souPackageFaqs`, {
          sou_package_id: formData.sou_package_id,
...
export default SOUPackageFAQSInsert;
