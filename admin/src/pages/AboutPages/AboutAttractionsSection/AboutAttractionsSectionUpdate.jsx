...
const AboutAttractionsSectionUpdate = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.put(`${BE_URL}/aboutAttractionsSection/${rowData.id}`, formData);
      setSuccess(true);
      setTimeout(() => {
        setSuccess(false);
            ...
            <div className="mt-2">
              ...
              <img
                src={
                  preview
                    ? preview
                    : `${BE_URL}/Images/AboutImages/Attractions/${rowData.image}`
                }
                alt="Attraction"
...
export default AboutAttractionsSectionUpdate;