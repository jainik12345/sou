...
const AboutAttractionsSectionTrace = () => {
  ...
  const fetchTrashedData = async () => {
    try {
      const res = await axios.get(`${BE_URL}/aboutAttractionsSection/trashed`);
  ...
  const handleRestore = async (id) => {
    try {
      await axios.patch(`${BE_URL}/aboutAttractionsSection/restore/${id}`);
    ...
    <div className="p-4 rounded-xl bg-white">
      ...
      <div className="flex justify-between mb-4">
        <h2 className="text-left font-semibold text-xl">
          About Attractions Section Trace
        </h2>
