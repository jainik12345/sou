...
const HomeNearAttractionsTrace = () => {
  ...
  const fetchTrashedData = async () => {
    try {
      const res = await axios.get(`${BE_URL}/homeNearAttractions/trashed`);
      ...
      console.error("Error fetching trashed attractions:", err);
    }
  };

  const handleRestore = async (id) => {
    try {
      await axios.patch(`${BE_URL}/homeNearAttractions/restore/${id}`);
...
export default HomeNearAttractionsTrace;
